...
keymap.set("n", "<leader>tn", function() require("trouble").next({ skip_groups = true, jump = true }) end)
keymap.set("n", "<leader>tp", function() require("trouble").previous({ skip_groups = true, jump = true }) end)
...
keymap.set("n", "<leader>cs", function() tb.colorscheme({ enable_preview = true }) end)
...
keymap.set("n", "<leader>fd", function() vim.diagnostic.open_float() end)
