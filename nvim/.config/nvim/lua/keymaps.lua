...
keymap.set("n", "<leader>d", "<cmd>TroubleToggle lsp_definitions<cr>", { silent = true, noremap = true })
keymap.set("n", "<leader>r", "<cmd>TroubleToggle lsp_references<cr>", { silent = true, noremap = true })
